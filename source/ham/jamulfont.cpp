...
void FontPrintStringColor(int x, int y, const char *s, const mfont_t *font, byte color, char bright)
{
	size_t len = strlen(s);
	for (size_t i = 0; i < len; ++i)
	{
...
void FontPrintStringGlow(int x, int y, const char *s, const mfont_t *font, char bright)
{
	size_t len = strlen(s);
	for (size_t i = 0; i < len; ++i)
	{
