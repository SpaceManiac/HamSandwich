...
// abilities
#define ABIL_FISH		0	// fishing!
#define ABIL_BRAIN		1	// brain radar
#define ABIL_SOLAR		2	// solar collector
#define ABIL_FIRSTAID	3	// first aid
#define ABIL_TRAINING	4	// training
#define ABIL_SHIELD		5	// shield
