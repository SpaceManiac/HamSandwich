...
#define PU_BRAIN	11	// brain detector
#define PU_SOLAR	12
#define PU_FIRSTAID	13
#define PU_TRAINING	14
#define PU_BLOCK	15
#define PU_BLASTING 16
#define PU_BIONIC	17
#define PU_OTHER	18	// the currently unknown power
#define MAX_POWERUP 19
