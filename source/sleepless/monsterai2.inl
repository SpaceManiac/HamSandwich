...
void AI_Ghost(Guy *me,Map *map,world_t *world,Guy *goodguy)
{
	...
	if(me->action==ACTION_BUSY)
	{
		...
		if(me->seq==ANIM_A1 && me->frm==2 && me->frmTimer>64)
		{
			...
			me->x+=(-320+Random(641))*FIXAMT;
			me->y+=(-240+Random(481))*FIXAMT;
...
void AI_Knight(Guy *me,Map *map,world_t *world,Guy *goodguy)
{
	...
	// unkillable... except by hyperlasers
	...
	// unaware, sitting in glass... permanently in this game!
	me->seq=ANIM_A1;
	me->frm=0;
	me->frmTimer=0;
	me->frmAdvance=2;
