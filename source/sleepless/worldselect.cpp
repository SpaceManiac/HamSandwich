			...
			for(i=0;i<3;i++)
			{
				...
				if(scoreMode==1)
				{
					if(i>=numScores)
						...
						sprintf(s,"%d:%02d.%02d",top3[i].score/(30*60),(top3[i].score/30)%60,(top3[i].score%30)*100/30);
				}
				else
				{
					if(i>=numScores)
