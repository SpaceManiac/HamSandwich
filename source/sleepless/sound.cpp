...
soundDesc_t soundInfo[MAX_SOUNDS]={
	...
	{SND_LEVELUP,"Level Up",ST_INTFACE|ST_VOCAL},
	{SND_WEAPONUP,"Weapon Up",ST_INTFACE|ST_VOCAL},
	...
	{SND_FISHCAST,"Fishing Cast",ST_PLAYER|ST_VOCAL},
	{SND_BOBSPLASH,"Bobber Landing",ST_EFFECT|ST_PLAYER},
	...
	{SND_BOBHIT,"Bobber Splashing",ST_INTFACE|ST_VOCAL},
	{SND_FISHCAUGHT,"Fish Caught",ST_INTFACE|ST_VOCAL},
...
void SaveCustomSounds(SDL_IOStream *f)
{
	int i;
...
void LoadCustomSounds(SDL_IOStream *f)
{
	int i;
...
int AppendCustomSounds(SDL_IOStream *f)
{
	int i,more,start;
...
owned::SDL_IOStream SoundLoadOverride(int num)
{
	...
	return owned::SDL_IOFromConstMem(buf, GetCustomLength(num - CUSTOM_SND_START));
}
