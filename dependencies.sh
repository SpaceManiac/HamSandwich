...
if command -v download_info >/dev/null 2>/dev/null; then
	...
	download_info CMAKE_VERSION Windows "https://github.com/Kitware/CMake/releases/download/v$CMAKE_VERSION/cmake-$CMAKE_VERSION-windows-x86_64.zip" d93958d87cc9b91983489f0b37a268b03a3c891894d11f5437fa2a5ce94aab24
	download_info CMAKE_VERSION Linux "https://github.com/Kitware/CMake/releases/download/v$CMAKE_VERSION/cmake-$CMAKE_VERSION-linux-x86_64.tar.gz" 3a5008b613eeb0724edeb3c15bf91d6ce518eb8eebc6ee758f89a0f4ff5d1fd6
	download_info CMAKE_VERSION Darwin "https://github.com/Kitware/CMake/releases/download/v$CMAKE_VERSION/cmake-$CMAKE_VERSION-macos10.10-universal.tar.gz" 0c6697ecba5f917d20d5c0757ed19cb6654362acd3d1e1da2d9263816384b4cb
