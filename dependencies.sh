...
export PYTHON_VERSION=3.6.8  # Read tools/bootstrap/python before upgrading.
...
if command -v download_info >/dev/null 2>/dev/null; then
	...
	download_info PYTHON_VERSION Windows "https://www.python.org/ftp/python/$PYTHON_VERSION/python-$PYTHON_VERSION-embed-amd64.zip" efadf25a090c8438b3cbe27574fb36bd40c80e20a03939188a1d5051685495dd
