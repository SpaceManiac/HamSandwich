...
if command -v download_info >/dev/null 2>/dev/null; then
	...
	download_info PYTHON_VERSION Linux "https://github.com/niess/python-appimage/releases/download/python$PYTHON_VERSION/python$PYTHON_VERSION.$PYTHON_LINUX_PATCH-cp$PYTHON_MAJOR$PYTHON_MINOR-cp$PYTHON_MAJOR$PYTHON_MINOR-${PYTHON_MANYLINUX}_x86_64.AppImage" cbab0a9e2b6771ca27b45166898675ea608c7acd0ccbb9c56f23c4b27e8e0d29
