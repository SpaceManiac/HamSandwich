...
if command -v download_info >/dev/null 2>/dev/null; then
	...
	download_info BUTLER_VERSION Windows "https://broth.itch.zone/butler/windows-amd64/$BUTLER_VERSION/archive/default" e5381a1ec38abe8c2f3bf742dc22e897901e7def22d20ebc8fd4490d52038d35
	download_info BUTLER_VERSION Linux "https://broth.itch.zone/butler/linux-amd64/$BUTLER_VERSION/archive/default" b640fceade5cafc7601b0ee57ba13c85913917eb5440375f7a605126f9ca2e1c
	download_info BUTLER_VERSION Darwin "https://broth.itch.zone/butler/darwin-amd64/$BUTLER_VERSION/archive/default" af8fc2e7c4d4a2e2cb9765c343a88ecafc0dccc2257ecf16f7601fcd73a148ec
